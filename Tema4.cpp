...
int main()
{
	...
	if (qnt_moedas_tira == 1 || (qnt_moedas_tira == 3 && moedas >= 3) || (qnt_moedas_tira == 4 && moedas >= 4))
			...
			
		{
			...
			if(pont_jog1 < 3 && pont_jog2 < 3) moedas = 10; else sair = true;
				// ------ POR QUE ESSA LINHA É NECESSÁRIA? -----
				// Teste com e sem ela, e comente!
				//Essa linha é necessária para que as parridas continuem até determina o ganhador após três rodadas
		...
		else
		{
			...
			// ------ POR QUE ESSA LINHA É NECESSÁRIA? -----
			// Teste com e sem ela, e comente!
			//Essa linha serve para que o jogo não "saia da tela" e para que ele continue, sem ela a tela ficaria aparentemente "piscando"
			system("pause");
		}
